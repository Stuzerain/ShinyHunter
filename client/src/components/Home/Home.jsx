...
const Home = () => {
  ...
  let fList = friendsList.map((friend, index) =>
  ...
  return (
    ...
    <div className={styles.main}>
      <div className={styles.intro}>
        ...
        <p>It also provides users with a sanity check in the form of a calculator! If you've shiny hunted before, surely you can relate to feeling like you've seen the same Pokemon thousands of times and getting frustrated that you haven't come across the shiny form yet. ShinyHunter provides a simple tick counter that lets you keep track of how many times you have seen a Pokemon, which is used to calculate the odds you haven't found your quarry yet. Now you can definitively PROVE to your friends how lucky or unlucky you were, and this information is stored with the Pokemon entry when you finally do catch it so you can remember your luck forever!</p>
      ...
      <div className={styles.resources}>
        ...
        <h3>Additional resources:</h3>
          <a href='https://bulbapedia.bulbagarden.net/wiki/Main_Page'>Bulbapedia</a> <br />
